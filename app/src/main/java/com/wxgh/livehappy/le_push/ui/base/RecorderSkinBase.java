package com.wxgh.livehappy.le_push.ui.base;
...
import com.wxgh.livehappy.le_push.ui.RecorderBottomView;
import com.wxgh.livehappy.le_push.ui.RecorderDialogBuilder;
import com.wxgh.livehappy.le_push.ui.RecorderTopFloatView;
				...
				public boolean OnLetvPublish(int code, final Object... msgs) {
					...
					case RecorderConstance.LIVE_STATE_NOT_STARTED_ERROR:
						handler.post(new Runnable() {
							@Override
							public void run() {
								Toast.makeText(context, msgs[0].toString(), Toast.LENGTH_SHORT).show();
								LeLog.w("直播已到结束时间");
								dimssLoadDialog();
							}
						});
