...
import com.wxgh.livehappy.le_play.skin.BaseViewGourp;
import com.wxgh.livehappy.le_play.skin.interfacev1.IActionCallback;
import com.wxgh.livehappy.le_play.skin.utils.ScreenUtils;
...
public class V4MultLiveRightView extends BaseViewGourp implements UIPlayContext.MultLiveStateChangeCallback {
    ...
    protected void initView(Context context) {
        ...
        showMultLiveViewClick = new View.OnClickListener() {
        ...
        multLiveViewParams = new LinearLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);
    ...
    private void initVideoView(final ViewGroup rootView, final String url, final MultLivePlayHolder mMultLivePlayHolder) {
        ...
        videoView.setLayoutParams(new ViewGroup.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
                ...
                if (mIActionCallback != null) {
                    ISplayer mISplayer = mIActionCallback.createPlayerCallback(holder, url, new OnPlayStateListener() {
                        ...
                        public void videoState(int state, Bundle bundle) {
                            Log.d("V4MultLive", "V4MultLiveLargeController-----state is : " + state);
                            switch (state) {
                    ...
                    Log.e("V4MultLive", "V4MultLiveLargeController----------- mCreatePlayerCallback is null");
                }
