package com.wxgh.livehappy.le_play.skin.popupwindow;
...
public class GestureBrightnessPopWindow extends BasePopupWindow {
    ...
    public void showPopWindow(View parent) {
        this.mPopupWindow = new PopupWindow(this.mPopView, RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT, false);
