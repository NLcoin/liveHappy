...
import com.wxgh.livehappy.le_play.skin.widget.MarqueeTextView;
...
//	private RequestQueue mRequestQueue;
    ...
    protected void initView(final Context context) {
         ...
         * 返回键
         */
        findViewById(ReUtils.getId(context, "full_back")).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(ReUtils.getId(context, "iv_video_inform")).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                informFuction();
            }
        ...
        videoLock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lockFlag = !lockFlag;
                if (lockFlag) {
...
//        requestActionConfig();
    ...
    private void informFuction() {
        if (informDialog == null) {
            ...
            informDialog.setContentView(view, new RelativeLayout.LayoutParams(PxUtils.dip2px(context, 230), PxUtils.dip2px(context, 120)));
            // 确认按钮
    ...
    private void requestInformMessage() {
        requestController.tipOff(uiPlayContext.getActivityId(), new BaseCallback<LinePeople>() {
            ...
            public void onSuccess(ResultJson<LinePeople> response) {
                ...
                view.addView(text);
                dialog.setContentView(view, new RelativeLayout.LayoutParams(PxUtils.dip2px(context, 173), PxUtils.dip2px(context, 80)));
                dialog.show();
